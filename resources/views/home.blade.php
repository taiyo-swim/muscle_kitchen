...
@section('content')
        ...
        <div class="click-search">
            ...
            <div id="mobile-size">
                <div id="recipe-cateogry">
                    <div class="ingredient-recipe-cateogry">
                        <h4>食材から探す</h4>
                        <ul>
                            <li class="item-meat">
                                <form method="get" action="/search">  
                                @csrf
                                    <p><i class="fas fa-angle-right"></i> お肉料理</p>
                                    <select name="keyword" onchange="this.form.submit()">
                                        <option value="" hidden>お肉料理</option>
                                        <option value="鶏むね肉">鶏むね肉</option>
                                        <option value="鶏もも肉">鶏もも肉</option>
                            ...
                            <li class="item-vegetable">
                                <form method="get" action="/search">  
                                @csrf
                                    <p><i class="fas fa-angle-right"></i> 野菜料理</p>
                                    <select name="keyword"  onchange="this.form.submit()">
                                        <option value="" hidden>野菜料理</option>
                                        <option value="ブロッコリー">ブロッコリー</option>
                                        <option value="アボカド">アボカド</option>
                                        <option value="大豆">大豆</option>
                                        <option value="オクラ">オクラ</option>
                            ...
                            <li class="item-fish">
                                <form method="get" action="/search">  
                                @csrf
                                    <p><i class="fas fa-angle-right"></i> 魚介料理</p>
                                    <select name="keyword"  onchange="this.form.submit()">
                                        <option value="" hidden>魚介料理</option>
                                        <option value="鮭・サーモン">鮭・サーモン</option>
                            ...
                            <li class="item-exet">
                                <form method="get" action="/search">  
                                @csrf
                                    <p><i class="fas fa-angle-right"></i> その他の食材</p>
                                    <select name="keyword"  onchange="this.form.submit()">
                                        <option value="" hidden>その他の食材</option>
                    ...
                    <div class="menu-recipe-cateogry">
                        <h4>料理から探す</h4>
                        <form method="get" action="/search">  
                        @csrf
                            <select name="keyword"  onchange="this.form.submit()">
                                <option value="" hidden>料理</option>
                                <option value="和食">和食</option>
                                <option value="中華">中華</option>
                                <option value="洋食">洋食</option>
                                <option value="イタリアン">イタリアン</option>
                                <option value="デザート">デザート</option>
                                <option value="丼物">丼物</option>
                                ...
                                <option value="卵焼き">卵焼き</option>
                                <option value="パンケーキ">パンケーキ</option>
                            </select>
                        </form>
                    </div>
                </div>
